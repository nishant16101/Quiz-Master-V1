...
@app.route('/admin/subjects.html', methods=['GET', 'POST'])
@login_required
def manage_subjects():
    if request.method == 'POST':
...
@app.route('/admin/chapters.html', methods=['GET', 'POST'])
@login_required
def manage_chapters():
    if request.method == 'POST':
...
@app.route('/admin/quizzes.html', methods=['GET', 'POST'])
@login_required
def manage_quizzes():
    if request.method == 'POST':
...
def delete_question(question_id):
    ...
    # Store quiz_id to redirect back
